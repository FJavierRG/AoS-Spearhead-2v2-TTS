...
-- TTS object: Bubble & Position Helper
-- GUID: 86398e
...
bubble3Btn={
    label="3\" bubble", click_function="bubble3", function_owner=self,
...
function bubble3(_, player, _)
    updateBubbles(player, 3)
end
